...
/***/ function(module, exports, __webpack_require__) {
	...
	var charting = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	    ...
	    var tempChart = exports.setupTemperatureChart({
	        width: width,
	        height: height,
	        axisSize: 20,
	        margin: 1
	    ...
	    d3.json('/data', function (data) {
	        ...
	        exports.drawTemperatureChart(chart, tempChart, data);
	    });
	});
	...
	exports.ChartBounds = ChartBounds;
	var TemperatureChartSpec = (function () {
	    function TemperatureChartSpec() {
	    }
	    return TemperatureChartSpec;
	}());
	exports.TemperatureChartSpec = TemperatureChartSpec;
	;
	exports.setupTemperatureChart = function (bounds) {
	...
	exports.makeMidnights = function (startTime, endTime) {
	    var results = [];
	    var t = startTime;
	    while (true) {
	        t.setHours(24, 0, 0, 0);
	...
	exports.drawPrecipBar = function (rootElt, chart, data) {
	...
	exports.drawTempMidnights = function (rootElt, chart, midnights) {
	...
	exports.drawTemperatureChart = function (rootElt, chart, data) {
	    ...
	    exports.drawTempMidnights(tempsLineG, chart, exports.makeMidnights(d3.min(data, function (d) { return new Date(d.unix_seconds * 1000); }), d3.max(data, function (d) { return new Date(d.unix_seconds * 1000); })));
	    exports.drawPrecipBar(tempsLineG, chart, data);
	    /*
	    var xAxisTranslate = {
	      x: 0,
	    ...
	    */
	    ...
	    tempsLineG.append('path')
	        ...
	        .attr('d', chart.line);
	    var minMaxSpecs = [
	        { label: "max", values: exports.selectMaxes(data, function (d) { return d.temperature; }) },
	        { label: "min", values: exports.selectMins(data, function (d) { return d.temperature; }) },
	    ];
